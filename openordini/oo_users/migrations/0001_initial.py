...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'oo_users_userprofile', (
            (u'userprofile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.UserProfile'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'oo_users', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'oo_users_userprofile')
